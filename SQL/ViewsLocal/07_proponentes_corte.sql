DROP VIEW IF EXISTS SICONV.solicitantes_corte;
CREATE VIEW SICONV.solicitantes_corte AS
...
--Estados
select 
	'ESTADO DE ' || upper(uf_proponente) as nm_proponente,
	natureza_juridica,
	regiao_proponente,
	uf_proponente,
	municipio_proponente,
